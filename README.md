...
3. **Этап 3**: Интерпретатор и операции с памятью
4. **Этап 4**: Реализация арифметико-логического устройства (команда bswap)
5. **Этап 5**: Выполнение тестовой задачи (векторные операции)
